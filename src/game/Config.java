...
public class Config {
    ...
    public static final Position POSITION_ENEMY_RIGHT = Position.of(600.f, 600.f);

    public static final String VARIANT_FONT_DEFAULT = "default";
    public static final String VARIANT_FONT_TITLE = "title";
    ...
    public static final List<ResourceAlias> DEFAULT_FONT = ResourceAlias.file(
            ...
            "https://st.1001fonts.net/download/font/bytebounce.medium.ttf").variant(
                    ...
                    ResourceVariant.of(Config.VARIANT_FONT_TITLE, Config.SIZE_FONT_TITLE));
